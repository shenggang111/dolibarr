...
/**
 * \file    test/phpunit/DispatchLaborFunctionalTest.php
...
/**
 * Class DispatchLaborFunctionalTest
 *
 ...
 *
 * @package Testdispatchlabor
 */
class DispatchLaborFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 136271; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDispatchLabor')->click();
		} else {
			// Disable the module
			$this->byHref('modDispatchLabor')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dispatchlabor/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dispatchlabor/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dispatchlabor/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dispatchlabor/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dispatchlaborwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDispatchLabor_DispatchLaborTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDispatchLabor_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
